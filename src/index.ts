...
function animate(deviceList: BaseController[]) {
...
function fade(deviceList: BaseController[], startCommand: IDeviceCommand, endCommand: IDeviceCommand, duration, interval) {
