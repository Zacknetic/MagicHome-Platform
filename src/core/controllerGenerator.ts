...
export class ControllerGenerator {
  ...
  private generateControllers(
    ...
    const activeControllers: Map<string, BaseController> =
      this.iterateDevices(deviceBundles);
    return activeControllers;
  }

  /**
   *  class function scanForUniqueIds
   * This is a function that will scan the network for devices with the provided uniqueIds
   * @param uniqueIds
   * @returns
   */
